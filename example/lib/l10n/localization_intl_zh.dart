...
class LZh extends L {
  ...
  String get description =>
      '<style size=30><gradient colors=\'appGreen,appOrange\' alignment=middle>Hypertext</gradient></style><gap=5 />是一个基于 <img src=\'https://storage.googleapis.com/cms-storage-bucket/c823e53b3a1a7b0d36a9.png\' height=30 width=102 /> 的<padding hor=5><style color=appBlue decor=underline decor-color=labelTertiary decor-style=wavy>高扩展性</style></padding>的富文本组件。\n\n@hypertext #rich #text #rich-text #localization';
